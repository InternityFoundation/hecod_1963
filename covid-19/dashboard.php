        <?php include('inc/header.inc.php'); ?>
            ...
            <div class="page-inner">
				<h3 class="breadcrumb-header mb-3">Covid-19 Dashboard</h3> 
                            ...
                            <div class="card card-white stats-widget bg-gradient-orange">
                                <div class="card-body">
                                    <div class="float-left">
                                        ...
                                        <p class="stats-info text-white"><a href="#" class="text-white">Body Temperature</a></p>
                                    </div>
                            ...
                            <div class="card card-white stats-widget bg-gradient-purple">
                                <div class="card-body">
                                    <div class="float-left">
                                        ...
                                        <p class="stats-info"><a href="#" class="text-white">Raise Alert</a></p>
                                    </div>
                                    <div class="float-right">
        ...
        1 </span>
                                        <p class="stats-info  text-white">Live Location</p>
                                    </div>
                                    <div class="float-right">
