        ...
        <div class="page-inner login-page">
            <div id="main-wrapper" class="container-fluid">
                <div class="row justify-content-center">
					...
					<h4 class="login-title">Register your Covid-19 account</h4>
						    <div id="success-alert"></div>
                        <form id="covidSignupForm">
                            ...
                            <div class="col-auto"><button type="submit" name="covidRegister" class="btn btn-block btn-outline-secondary">Register &rarr;</button></div>
							</div>
...
<script src="../ajax/covid-register.js"></script>
</body>
</html>