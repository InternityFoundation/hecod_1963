...
<?php $result = $adData->AllData('covid'); ?>
 
        		<!-- start page inner -->
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">Quarantined List</h3>
                </div>
													...
													<td class="btn-group">
														...
														<span class="caret"></span></button>
															<ul class="dropdown-menu" role="menu">
																<li><button type="button" class="btn btn-text text-success" data-toggle="modal" data-target=".bs-example-modal-lg-<?php echo $userData->covidId; ?>"><i class="fas fa-eye"></i> View</button></li>
																<li><a href="#" class="delete text-danger" data-id="<?php echo $userData->covidId; ?>"><i class="fas fa-trash"></i> Remove</a></li>
															</ul>
													</td>
                                                <div class="modal fade bs-example-modal-lg-<?php echo $userData->covidId; ?>" id="bp" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content bg-gradient-purple">
                                                <div class="modal-header">
                                                    <h4 class="modal-title text-white" id="myLargeModalLabel">User Details</h4>
											...
											<input class="form-control" type="hidden" name="users_id" value="<?php echo $data->id; ?>">
												...
												<div class="alert alert-default">Location Status : ON</div>                                        
                                                <div class="alert alert-default">App Status : ON</div>                                        
                                                <div class="alert alert-default">Photo Send Status : ON</div>                                       
                                                <div class="alert alert-default">Raise Alert : NO</div>
                                                <div class="alert alert-default">Location History : NO</div>
                                                <div class="alert alert-default">Admin View History : NO</div>
                                                <div class="alert alert-default">Medical Facility Requied : NO</div>
