		...
		<!-- start page inner -->
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">Respiratory Rate</h3>
                </div>
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-auto">
                                                <button type="button" class="btn btn-outline-warning" data-toggle="modal" data-target=".bs-example-modal-lg">Add Respiratory Rate</button>
                                                <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title text-warning" id="myLargeModalLabel">Add Respiratory Rate</h4>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-form-label required required">Result</label>
                                                <input class="form-control" type="text" placeholder="4-100 (breaths per minute)">
                                        </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-12">
