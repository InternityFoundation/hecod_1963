<form id="piForm">
	...
	<input class="form-control" type="hidden" name="users_id" value="<?php echo $data->id; ?>">
        <div class="col-md-4">
            ...
            <input class="form-control" type="text" name="firstName" placeholder="First Name" value="<?php echo $joindata->firstName; ?>">
        </div>
		<div class="col-md-4">
            <label class="col-form-label">Middle Name</label>
            <input class="form-control" type="text" name="middleName" placeholder="Middle Name" value="<?php echo $joindata->middleName; ?>">
                                        </div> 
                                        <div class="col-md-4">
                                            <label class="col-form-label required">Last Name</label>
                                                <input class="form-control" type="text" name="lastName" placeholder="Last Name" value="<?php echo $joindata->lastName; ?>">
                                        </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                            <label class="col-form-label required">Date Of Birth</label>
                                                <input type="text" class="form-control date-picker" name="dob" placeholder="DD/MM/YYYY" value="<?php echo $joindata->dob; ?>">
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-form-label required">Adhaar</label>
                                                <input class="form-control" type="text" name="adhaar" placeholder="Adhaar" value="<?php echo $joindata->adhaar; ?>">
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-3">
                                            <label class="col-form-label required">Mobile</label>
												...
												<a href="#" id="mobileVerify" data-id="<?php echo $joindata->mobile; ?>">Verify</a>
												<div id="otpdis"></div>
                                        </div>                                        
                                        <div class="col-md-3">
                                            <label class="col-form-label">Secondary Mobile</label>
                                                <input class="form-control" type="number" name="secMobile" placeholder="Secondary Mobile" value="<?php echo $joindata->secMobile; ?>">
                                        </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                            <label class="col-form-label required">Address Line 1</label>
                                                <input class="form-control" type="text" name="addLine1" placeholder="Address Line 1" value="<?php echo $joindata->addLine1; ?>">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="col-form-label required">Address Line 2</label>
                                                <input class="form-control" type="text" name="addLine2" placeholder="Address Line 2" value="<?php echo $joindata->addLine2; ?>">
                                        </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-3">
                                            <label class="col-form-label required">Town/City</label>
                                                <input class="form-control" type="text" name="city" placeholder="Town/City" value="<?php echo $joindata->city; ?>">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="col-form-label required">Distric</label>
                                                <input class="form-control" type="text" name="distric" placeholder="Distric" value="<?php echo $joindata->distric; ?>">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="col-form-label required">State</label>
                                                <input class="form-control" type="text" name="state" placeholder="State" value="<?php echo $joindata->state; ?>">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="col-form-label required">Pincode</label>
                                                <input class="form-control" type="number" name="pincode" placeholder="Pincode" value="<?php echo $joindata->pincode; ?>">
                                        </div>
                                        </div>
										<div class="form-group row">
                                            <div class="col-md-3 offset-md-9">
											<button type="submit" name="pi" class="btn btn-danger large">Save</button>
                                        </div>
                                        </div>
										</form>