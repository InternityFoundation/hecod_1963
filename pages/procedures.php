		...
		<!-- start page inner -->
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">Procedure</h3>
                </div>
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-auto">
                                                <button type="button" class="btn btn-outline-warning" data-toggle="modal" data-target=".bs-example-modal-lg">Add Procedure</button>
                                                <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title text-warning" id="myLargeModalLabel">Add Procedure</h4>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                            <label class="col-form-label required">Procedure</label>
                                            <div class="input-group mb-3">
                                                    <input type="text" class="form-control">
                                                    <span class="input-group-prepend last">
                                        ...
                                        <div class="form-group row">										
                                        <div class="col-md-6">
                                            <label class="col-form-label required">Performed By:</label>
                                                <input class="form-control" type="text" placeholder="Doctor/Hospital">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="col-form-label required">Date of Procedure:
                                                </label>
                                                <input class="form-control date-picker" type="text" placeholder="DD/MM/YYYY">
                                        </div>
                                        </div>
										<div class="row">
										<label class="col-form-label ml-3">Procedure</label>
